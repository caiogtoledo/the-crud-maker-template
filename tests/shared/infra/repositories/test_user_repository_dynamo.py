...
from src.shared.infra.repositories.dynamo.user_repository_dynamo import UserRepositoryDynamo
...
class Test_UserRepositoryDynamo:
    ...
    def test_create_user(self):
        ...
        user_repository_mock = UserRepositoryMock(use_singleton=False)
